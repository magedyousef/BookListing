...
import static com.example.maged.booklisting.R.id.books_list;
...
public class MainActivity extends AppCompatActivity {
    ...
    private ConnectivityManager intmgr;
    private NetworkInfo intinfo;
    private String search_query;
    private TextInputLayout search_container;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        books_view = (ListView) findViewById(books_list);
    ...
    private class BookAsyncTask extends AsyncTask<String, Void, List<Book>> {
        ...
        protected void onPostExecute(List<Book> books) {
            ...
            loading.setVisibility(View.INVISIBLE);
            ListView books_view = (ListView) findViewById(R.id.books_list);
            books_view.setEmptyView(findViewById(R.id.empty_view));
            adapter.clear();
